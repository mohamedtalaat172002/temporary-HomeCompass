...
namespace HomeCompassApi.Migrations
{
    ...
    [Migration("20240228202940_CreatDbTables")]
    partial class CreatDbTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeCompassApi.Models.Feed.Like", b =>
                {
            ...
            modelBuilder.Entity("HomeCompassApi.Models.Info", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeCompassApi.Models.ApplicationUser", b =>
                {
                    b.OwnsMany("HomeCompassApi.Models.Auth.RefreshToken", "RefreshTokens", b1 =>
                        {
            ...
            modelBuilder.Entity("HomeCompassApi.Models.Feed.Like", b =>
                {
                    b.HasOne("HomeCompassApi.Models.Feed.Post", null)
                        .WithMany("Likes")
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
